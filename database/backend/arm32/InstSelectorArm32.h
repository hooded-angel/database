...
protected:
    ...
    /// @param inst IR指令
    void translate_icmp_eq(Instruction * inst);

    /// @brief 整数不等于比较指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_icmp_ne(Instruction * inst);

    /// @brief 整数小于比较指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_icmp_lt(Instruction * inst);

    /// @brief 整数小于等于比较指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_icmp_le(Instruction * inst);

    /// @brief 整数大于比较指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_icmp_gt(Instruction * inst);

    /// @brief 整数大于等于比较指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_icmp_ge(Instruction * inst);
